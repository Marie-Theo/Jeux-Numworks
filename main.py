...
setting = Options([["Morpion","adver:",["bot random","bot ia","2 j"]],["Demineur","mine:",[str(n) for n in range(5,36)]],["Snake","vitesse * ",["1","2","3"]],["Pong","niveaux ",["easy","normal","hard"]],["Main","colors:",["jaune","cyan","rouge","mauve","vert","rose"]],["Couleur","",["black on white","white on black"]]],65,20,190,180,c,bg_C=c[1])
